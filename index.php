			   ...
			   <li class="nav-item"><a class="nav-link" href="about.html">About</a></li>
			    ...
			    <li class="nav-item dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="dropdown02">
						<li><a class="dropdown-item" href="department.html">As A Driver</a></li>
						<li><a class="dropdown-item" href="department.html">As A Patient</a></li>
                </ul>
			  	</li>
		...
		<div class="row">
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="service-item mb-4">
					...
					<div class="content">
						<p class="mb-4">A fully equiped ambulance, ready to provide essential support sent to the aid of the patients by our partner hospitals and other organizations. </p>
					</div>
				</div>
			</div>
		...
		<div class="row justify-content-center">
			<div class="col-lg-7">
				<div class="section-title text-center">
					...
					<p>We have over 50 Hospitals who have partnered with us to provide their ambulances and other services directly on our application. This makes our application a one stop destination for all your medical emergencies and needs.</p>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="widget widget-contact mb-5 mb-lg-0">
					...
					<div class="footer-contact-block">
						<div class="icon d-flex align-items-center">
							...
							<span class="h6 mb-0">24x7</span>
						</div>
						<h4 class="mt-2"><a href="tel:+23-345-67890">+916005833691</a></h4>
					</div>
				</div>
			</div>
		</div>
